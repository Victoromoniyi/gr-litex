...
#define CSR_ICAP_SEND_ADDR (CSR_BASE + 0x2008L)
...
#define CSR_PCIE_DMA0_WRITER_TABLE_FLUSH_ADDR (CSR_BASE + 0x381cL)
...
#define CSR_PCIE_DMA0_READER_TABLE_FLUSH_ADDR (CSR_BASE + 0x383cL)
...
#define CSR_PCIE_PHY_LINK_STATUS_ADDR (CSR_BASE + 0x4800L)
...
#define CSR_PCIE_PHY_MSI_ENABLE_ADDR (CSR_BASE + 0x4804L)
#define CSR_PCIE_PHY_MSI_ENABLE_SIZE 1
#define CSR_PCIE_PHY_MSIX_ENABLE_ADDR (CSR_BASE + 0x4808L)
#define CSR_PCIE_PHY_MSIX_ENABLE_SIZE 1
#define CSR_PCIE_PHY_BUS_MASTER_ENABLE_ADDR (CSR_BASE + 0x480cL)
#define CSR_PCIE_PHY_BUS_MASTER_ENABLE_SIZE 1
#define CSR_PCIE_PHY_MAX_REQUEST_SIZE_ADDR (CSR_BASE + 0x4810L)
#define CSR_PCIE_PHY_MAX_REQUEST_SIZE_SIZE 1
#define CSR_PCIE_PHY_MAX_PAYLOAD_SIZE_ADDR (CSR_BASE + 0x4814L)
